...
class Project:
    ...
    def __init__(self, name="", strat_date=datetime.datetime.today().date(), priority=0, cost_estimate=0.0,
    ...
    def __str__(self):
        ...
        return f"{self.name}, start: {self.strat_date.strftime("%d/%m/%Y")}, priority {self.priority}, estimate: ${self.cost_estimate:,.2f}, completion: {self.completion_percentage}%"
    ...
    def is_recent(self, threshold=datetime.datetime.today().date()):
        ...
        return self.strat_date > threshold
